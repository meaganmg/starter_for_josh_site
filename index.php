...
<section class= "container-fluid text-center aboutbg">
        <div class="container">
          ...
          <p class="about-text">My  name is josh Whitkin. I’m a 
  professional with more than 7 years of industry experience in Games Design,
  Level design, Scripting and Visual Effects.  What makes me passionate about
  games is the combination of technology  and creativity, and how multiple disciplines come together to create an interactive experience. Whether I'm designing for puzzle games, 2D platformers or 3D environments.
...
<div class="col-md-4">
    <img class="img-fluid" src="http://170.187.231.66/~mesh1/wp-content/themes/starter_for_josh_site/images/port2.jpg"> alt="character">
    <h4 class="article-title">A PORTRAIT</h4>
    <p class="date">Friday 12 December 2020</p>
    <p class="article-p">STS has never been shy of seeking new terrains of investigation. More and more STS scholars are starting to explore and intervene in the arts. This object of study brings new challenges and opportunities that we want to explore in this session. We would like to gather first of all simply new kinds of knowledge arising from STS study of the arts.
    </p>
